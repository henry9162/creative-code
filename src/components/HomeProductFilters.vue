                    ...
                    <div class="filter-products">
                        <div class="filters" >
                            <v-hover v-for="(filter, i) in filters" :key="i" v-slot:default="{ hover }">
                                <v-btn tile height="55" @click="filterButtons(filter)" x-large :class="hover || active == filter.title ? 'white--text' : 'border grey--text text--darken-3'" :color="hover || active == filter.title ? 'rgba(231, 40, 77, 1)' : ''" depressed light>
                        ...
                        <div class="all-categories-filter">
                            <v-hover v-slot:default="{ hover }">
                                <v-btn tile height="55" x-large :class="hover ? 'white--text' : 'border grey--text text--darken-3'" :color="hover ? 'rgba(231, 40, 77, 1)' : ''" depressed>
                                    <span>
                        ...
                        <v-card color="white" max-width="400" :elevation="hover ? 20 : 1">
                            ...
                            <v-card-text class="pt-6" style="position: relative;">
                                ...
                                <div style="display: flex; justify-content: space-between; max-height: 20px">
                                    ...
                                    <h3 class="font-weight-black title">$14.99</h3>
                                </div>
                            </v-card-text>
                                ...
                                <v-hover v-slot:default="{ hover }">
                                    <v-card color="white" max-width="400" :elevation="hover ? 20 : 0">
                                        ...
                                        <v-expand-transition>
                                            <div v-show="show == true && productId == product.id">
                                                <v-card-text>
                                                    Add more product description here
                                                </v-card-text>
                                            </div>
                                        </v-expand-transition>
                                    </v-card>
...
export default {
    ...
    computed: {
        deals() { return this.products.slice(0, 4); },
