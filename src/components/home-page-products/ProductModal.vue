                        ...
                        <div class="mt-3">
                            <v-card flat >
                                <v-card-text class="caption">
                                    <div><span class="subtitle-2 font-weight-bold">Stock: </span> <span class="font-weight-bold" :class="product.inventory > 0 ? 'green--text' : 'red--text'">{{ product.inventory > 0 ? product.inventory : 'Out Of Stock' }}</span></div>
