<template>
    <div>
        <v-app-bar app dark color="#313846">
            ...
            <v-menu v-model="menu" close-delay="200" max-width="900" :close-on-content-click="false" nudge-bottom="13" nudge-left="320" open-on-hover :nudge-width="200" offset-y>
                                                ...
                                                <v-list-item-group color="pink">  
                                                    <v-list-item v-for="(item, i) in items" :key="i">
                                                        <v-list-item-icon class="ml-3 mr-2">
                                                            <v-icon class="blue--text" right v-text="item.icon"></v-icon>                               
                                                        </v-list-item-icon>
                                                        <v-list-item-content >
                                                            <v-list-item-title class="blue--text" v-text="item.text"></v-list-item-title>
                                                        </v-list-item-content>
                                                    </v-list-item>         
                                                </v-list-item-group>
                                            </v-list>
